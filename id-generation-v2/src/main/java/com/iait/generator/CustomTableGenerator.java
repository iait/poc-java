...
public class CustomTableGenerator implements PersistentIdentifierGenerator, Configurable {
    private static final CoreMessageLogger LOG = Logger.getMessageLogger(
            ...
            CustomTableGenerator.class.getName()
    );
                            ...
                            public IntegralDataTypeHolder execute(Connection connection) throws SQLException {
                              ...
                              do {
                                  ...
                                  try (PreparedStatement selectPS = prepareStatement(
                                      ...
                                      selectPS.setString( 1, localSegmentValue );
                                      ...
                                      if ( !selectRS.next() ) {
                                          ...
                                          try (PreparedStatement insertPS = prepareStatement(
                                              ...
                                              LOG.tracef( "binding parameter [%s] - [%s]", 1, localSegmentValue );
                                              insertPS.setString( 1, localSegmentValue );
                                  ...
                                  try (PreparedStatement updatePS = prepareStatement(
                                      ...
                                      updatePS.setString( 3, localSegmentValue );
